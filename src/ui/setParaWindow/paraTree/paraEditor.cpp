...
#include <QLineEdit>
#include <QComboBox>
CParaEditor::CParaEditor(QWidget *parent, const CParaNodeAttributes& p_nodeAttributes, const int &w, const int &h) : QWidget(parent), editor(nullptr)
{
...
#define _NewEditor(QWidgetName)           \
    ...
    case pntBool:
    {
        ...
        pEditor->setStyleSheet(QString("QRadioButton::indicator{\
                        width:%1px;\
                        height:%2px;}\
                    QRadioButton{\
